...
from .views import DoAnOrderView, OrderConfirmationView, PaymentGatewayView, ProcessPaymentView, OrderStatusView
...
urlpatterns = [
    ...
    path('order_status/', OrderStatusView.as_view(), name='order_status'),  # Nueva ruta
]